...
(function ($) {
  ...
  /* Scroll Animation
   * ------------------------------------------------------ */
  function ssScrollAnimation() {
    $WIN.on("scroll", function () {
      var scrollTop = $WIN.scrollTop();
      var winHeight = $WIN.height();
      var triggerPoint = scrollTop + winHeight * 0.85; // Trigger when element is 15% visible from bottom
  ...
  /* Add to Calendar
   * ------------------------------------------------------ */
  function ssAddToCalendar() {
    $(".btn-calendar").on("click", function (e) {
      e.preventDefault();
      var $this = $(this);
      var title = $this.data("title");
      var location = "160 OFF BAI BUREH ROAD, KISSY";
      var description = $this.data("description");
      var start = $this.data("start"); // Format: YYYYMMDDTHHMMSS
      var end = $this.data("end"); // Format: YYYYMMDDTHHMMSS
